...
[官方网站](https://zxbb1190.github.io/SceneGo/) · [GitHub Releases](https://github.com/zxbb1190/SceneGo/releases)
...
- 宣传官网通过 GitHub Pages 自动部署，支持中英文切换与移动端访问。
- 项目采用 MIT License。
...
website               SceneGo 宣传官网与 GitHub Pages 构建
scripts               本地 smoke test 辅助脚本
```

## 截图与 Demo

访问 [SceneGo 官方网站](https://zxbb1190.github.io/SceneGo/) 查看产品介绍、真实界面截图、部署方式与项目边界。
